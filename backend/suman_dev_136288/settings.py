"""
Django settings for suman_dev_136288 project.
...
ROOT_URLCONF = 'suman_dev_136288.urls'
...
WSGI_APPLICATION = 'suman_dev_136288.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "suman Support <support@suman-dev-136288.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "suman_dev_136288 API",
    "DESCRIPTION": "API documentation for suman_dev_136288 App",
    "VERSION": "v1",
}
